...
screenshot_path = r"C:\Users\Amaan\.gemini\antigravity\brain\a560f167-0818-4009-a21f-ab6aad534b99\media__1780467714267.png"

with Image.open(screenshot_path) as img:
    width, height = img.size
    print(f"New screenshot size: {img.size}")
    ...
    for y in range(0, height, 20):
        ...
        for x in range(width):
            ...
            # The background is very dark (RGB values <= 10)
            is_non_black = (r > 15 or g > 15 or b > 15)
